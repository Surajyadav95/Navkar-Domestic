...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Domestic/DomesticEmptyInPrint.rdlc")
            ...
            'GPNO = "1"
            ds = db.sub_GetDataSets("USP_DOMESTIC_EMPTY_IN_PRINT " & SlipNo & "")
            ...
            Dim DriverCode As String = Trim(ds.Tables(0).Rows(0)("DriverCode") & "")            
            ...
            Dim p5 As New ReportParameter("DriverCode", DriverCode)
            ...
            Dim p14 As New ReportParameter("UserName", UserName)
