...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Domestic/TruckSlipDomesticPrint.rdlc")
            ...
            'GPNO = "1"
            ds = db.sub_GetDataSets("USP_DOMESTIC_TRUCK_SLIP_PRINT " & SlipNo & "")
            ...
            Dim BatchNo As String = Trim(ds.Tables(0).Rows(0)("BatchNo") & "")
            Dim Weight As String = Trim(ds.Tables(0).Rows(0)("Weight") & "")
            ...
            Dim p21 As New ReportParameter("UserName", UserName)
            Dim p22 As New ReportParameter("BatchNo", BatchNo)
            Dim p23 As New ReportParameter("Weight", Weight)
            Dim p24 As New ReportParameter("InvoiceNo", InvoiceNo)
            Dim p25 As New ReportParameter("Transporter", Transporter)

            Me.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25})
