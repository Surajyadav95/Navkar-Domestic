<%@ Page Title="Domestic" Language="VB" EnableEventValidation="false" MasterPageFile="~/Domestic/PopUp.master" AutoEventWireup="false" CodeFile="ContainerListforDestuffing.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<b >Search</b>
<asp:TextBox ID="txtsearch" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search by Container No,Customer,BOE No or Ref JO No"
...
<asp:BoundField DataField="BENO" HeaderText="BOE No"></asp:BoundField>
<asp:BoundField DataField="REFJONO" HeaderText="Ref. JO No"></asp:BoundField>
