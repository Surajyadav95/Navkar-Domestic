<%@ Page Title="Domestic" Language="VB" EnableEventValidation="false" MasterPageFile="~/Domestic/PopUp.master" AutoEventWireup="false" CodeFile="DomesticGatePassSearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
//  alert(window.opener.document.getElementById("_btnIndentItem"));
    window.opener.document.getElementById("MainContent_btnDomesticgate").click();
self.close();
}
</script>
...
<h1>Loading Search<small class="pull-right" style="margin-right: 20px"></small></h1>
...
<ItemStyle HorizontalAlign="Left" Width="80px" />
    ...
    <asp:TemplateField HeaderText="Gate In No">
        <ItemTemplate>
            <asp:Label runat="server" ID="lblLoadedID" Text='<%#Eval("GateIn_no")%>'></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
...
<script type="text/javascript" >
function callparentfunction() {
    window.opener.document.getElementById("ContentPlaceHolder1_btnDomesticgate").click();
self.close();
}
</script>    
</asp:Content>
