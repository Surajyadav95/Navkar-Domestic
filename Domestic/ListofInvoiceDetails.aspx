<%@ Page Title="Domestic | List of Invoice" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Domestic | List of Invoice .</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>List of Invoice Proforma 
</h3>
...
<a  href='<%# "../Report_Domestic/DomesticInvoicePrint.aspx?AssessNo=" & (DataBinder.Eval(Container.DataItem, "ASSESSNO")).ToString() & "&WorkYear=" & (DataBinder.Eval(Container.DataItem, "WorkYear")).ToString()%>' target="_blank"
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "InvoiceNo")%>' runat="server"></asp:LinkButton>  
    <asp:LinkButton ID="lnkSumbit" ControlStyle-CssClass='btn btn-success btn-xs outline' Text="Sumbit"  OnClick="lnkSumbit_Click" 
    OnClientClick="return confirm('Are you sure to Sumbit?')"
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ASSESSNO")%>' runat="server"></asp:LinkButton>                                           
</ItemTemplate>
