<%@ Page Title="Domestic |Empty Out Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="EmptyOutSummary.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Domestic |Empty Out Summary</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Empty Out Summary 
            </h3>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                         <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Domestic/DomesticEmptyOutPrint.aspx?SlipNo=" & (DataBinder.Eval(Container.DataItem, "Out No")).ToString()%>'target="_blank" 
