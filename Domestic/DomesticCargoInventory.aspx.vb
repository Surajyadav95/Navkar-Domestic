...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            Dim dblPkgs As Double = 0, dblWeight As Double = 0, dblValue As Double = 0
            strSql = ""
            strSql += " usp_cargo_Inventory_Domestic '" & Convert.ToDateTime(txtdate.Text).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(ddlCategory.SelectedValue & "") & "',"
            ...
            For i = 0 To dt.Rows.Count - 1
                dblPkgs += Val(dt.Rows(i)("Balance Qty"))
                dblWeight += Val(dt.Rows(i)("Balance Wt"))
            Next
            lblA.Text = Val(dblPkgs)
            lblB.Text = Val(dblWeight)
        Catch ex As Exception
            lblError.Text = "Error in procedure: " & Reflection.MethodBase.GetCurrentMethod.Name & ". " & ex.Message.ToString
        End Try
    End Sub
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        Try
            Dim dblPkgs As Double = 0, dblWeight As Double = 0
            strSql = ""
            strSql += " usp_cargo_Inventory_Domestic '" & Convert.ToDateTime(txtdate.Text).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(ddlCategory.SelectedValue & "") & "',"
            strSql += "'" & Trim(ddlcustomer.SelectedValue & "") & "','" & Trim(ddlLineNAme.SelectedValue & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Cargo Inventory " & Convert.ToDateTime(txtdate.Text).ToString("dd-MM-yyyy") & "")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Row(6).Height = 20
                        .Row(6).Height = 20
                        .Cell(6, 1).Value = "As On: " + Convert.ToDateTime(txtdate.Text).ToString("dd MMM yyyy")
                        .Cell(6, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                        .Cell(7, 1).Value = "Cargo Summary"
                        ...
                        .Cell(10 + dt.Rows.Count, 2).Value = "Balance Pkgs"
                        .Cell(10 + dt.Rows.Count, 3).Value = dblPkgs
                        .Cell(10 + dt.Rows.Count, 2).Style.Fill.BackgroundColor = XLColor.Yellow
                        .Cell(10 + dt.Rows.Count, 3).Style.Fill.BackgroundColor = XLColor.Yellow
                        .Cell(10 + dt.Rows.Count, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                        .Cell(10 + dt.Rows.Count, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                        .Cell(10 + dt.Rows.Count, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right
                        .Cell(10 + dt.Rows.Count, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                        .Cell(11 + dt.Rows.Count, 2).Value = "Balance Weight"
                        .Cell(11 + dt.Rows.Count, 3).Value = dblWeight
                        .Cell(11 + dt.Rows.Count, 2).Style.Fill.BackgroundColor = XLColor.Yellow
                        .Cell(11 + dt.Rows.Count, 3).Style.Fill.BackgroundColor = XLColor.Yellow
                        .Cell(11 + dt.Rows.Count, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                        .Cell(11 + dt.Rows.Count, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                        .Cell(11 + dt.Rows.Count, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right
                        .Cell(11 + dt.Rows.Count, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
