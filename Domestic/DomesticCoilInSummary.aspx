<%@ Page Title="Domestic |Coil In Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="DomesticCoilInSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Domestic | Coil In Summary</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Coil In Summary 
</h3>
...
Commodity 
<asp:DropDownList ID="ddlCommodity"   runat="server"  class="form-control text-label">
</asp:DropDownList>
</div>
