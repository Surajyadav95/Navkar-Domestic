...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Filldropdown()
        Try
            ds = db.sub_GetDataSets("usp_Domestic_summary_search")
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            ...
            ElseIf txtigmno.Text <> "" Then
                strSearchText = txtigmno.Text
            ElseIf txtItemNo.Text <> "" Then
                strSearchText = txtItemNo.Text
            End If

            strSql = ""
            strSql += " usp_Domestic_Destuff_Search '" & Convert.ToDateTime(txtfromDate.Text).ToString("dd MMM yyyy 00:00:00 ") & "','" & Convert.ToDateTime(txttoDate.Text).ToString("dd MMM yyyy 23:59:00 ") & "',"
            strSql += "'" & Trim(ddlCategory.SelectedValue & "") & "','" & Trim(ddlCustomer.SelectedValue & "") & "','" & strSearchText & "'"
