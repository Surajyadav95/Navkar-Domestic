...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from TEMP_TARIFF_SEARCH_Domestic Where UserID=" & Session("UserId_DomCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " USP_TARIFF_SEARCH_LIST_Domestic '" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "insert into TEMP_TARIFF_SEARCH_Domestic (TARIFFID,userid,TARIFFDESCRIPTION,ENTRYID) Values('" & Auto_Id & "','" & Session("UserId_DomCFS") & "','" & Trim(CType(gr.FindControl("lblTariffDescription"), Label).Text) & "','" & Trim(CType(gr.FindControl("lblEntryID"), Label).Text) & "')"
