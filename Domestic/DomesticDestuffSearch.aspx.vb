...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from Temp_JO_List_Domestic Where userid=" & Session("UserId_DomCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " usp_domestic_search_container '" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "insert into Temp_JO_List_Domestic (ContainerNo,userid,AddedOn) Values('" & Auto_Id & "','" & Session("UserId_DomCFS") & "',Getdate())"
