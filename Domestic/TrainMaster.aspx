<%@ Page Title="Domestic | Train Master" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="TrainMaster.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Domestic | Train Master</title>
...
<i class="glyphicon glyphicon-transfer"></i> Train Master 
</h3>
...
<div class="form-group text-label" style="text-decoration-color:black">
<b >Rake No</b>
<asp:TextBox ID="txtRakeNo" Style="text-transform: uppercase" MaxLength="20" class="form-control text-label form-cascade-control"
runat="server"></asp:TextBox>     
</div>
</div>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Wagon Type" HeaderStyle-CssClass="center-header">
        <ItemTemplate>
       <asp:Label ID="lblWagonType" runat="server" text='<%#Eval("WagonType")%>'></asp:Label>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Center" /> 
        </asp:TemplateField>
    <asp:TemplateField HeaderText="Capacity" HeaderStyle-CssClass="center-header">
        <ItemTemplate>
...
<a href="TrainMaster.aspx" id="btnclear" runat="server" class="btn btn-primary btn btn-sm outline ">
Clear
</a> 
...
<a href="TrainSummary.aspx" target="_blank"><b style="color:blue">Click here to view Train Summary</b> </a>
        ...
        <div class="row">
            <div class="col-lg-6 pull-right" style="margin-left:6px;">
<div class="form-group ">
<a href="#" onclick="getRRUpdate()"><b style="color:blue">Click here to Update RR No</b> </a>
</div>
</div>
        </div>            
...
<a href="TrainMaster.aspx" class="btn btn-info btn-block">OK</a>
...
alert("Invalid Mobile number.");
    ...
    <script type="text/javascript">
        var popup;
        function getRRUpdate() {
            var url = "DomesticUpdateRR.aspx"

            popup = window.open(url, "Popup", "width=710,height=555,top=100,left=450");
            popup.focus();
        }
</script>
</asp:Content>
