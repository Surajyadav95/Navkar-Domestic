...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            txtworkyear.Text = strWorkyear
            strSql = ""
            strSql = "USP_COPY_INSERT_AssessM'" & Trim(txtinvno.Text & "") & "','" & Trim(txtworkyear.Text & "") & "','" & Session("UserID") & "'"
            dt = db.sub_GetDatatable(strSql)
            btnSave.Text = "Copy"
    ...
    Protected Sub txtinvno_TextChanged(sender As Object, e As EventArgs) Handles txtinvno.TextChanged
        Try
            Clear()          
            strSql = ""
            strSql += "USP_modify_assessment_assessno_textchanged_Domestic '" & Trim(txtinvno.Text & "") & "','" & Session("UserID") & "','" & Trim(txtworkyear.Text) & "'"
    ...
    Public Sub FillGrid()
        Try
            strSql = ""
            strSql += "USP_fetch_from_temp_modify_assessment_Domestic '" & Session("UserID") & "'"
            ds = db.sub_GetDataSets(strSql)
