...
CodeFile="LoadingSummary.aspx.vb" Inherits="Summary_BCYMovement" %>
...
<asp:ListItem Value="1">Loading Type</asp:ListItem>
...
<asp:TemplateField>
<ItemTemplate>
<a  href='<%# "../Report_Domestic/LoadingSheetPrint.aspx?SheetNo=" & (DataBinder.Eval(Container.DataItem, "Loaded ID")).ToString()%>'target="_blank" 
...
<asp:TemplateField>
<ItemTemplate>                                                                                                                        
<asp:LinkButton ID="lnkcancel"  ControlStyle-CssClass='btn btn-primary btn-xs outline' Text="Cancel"  OnClick="lnkcancel_Click"                                              
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Loaded ID")%>' runat="server"  
></asp:LinkButton>   
</ItemTemplate>
