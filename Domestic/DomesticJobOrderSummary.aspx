...
<asp:TemplateField>
<ItemTemplate>
<a  href='<%# "DomesticJobOrder.aspx?JONoView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "JO NO")).ToString())%>' target="_blank"
Class='btn btn-success btn-xs outline' 
>View</a>
<a  href='<%# "DomesticJobOrder.aspx?JONoEdit=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "JO NO")).ToString())%>' target="_blank"
...
<%--<asp:BoundField DataField="REMARKS" HeaderText="Remarks"></asp:BoundField>--%> 
    ...
    <asp:BoundField DataField="FromLocation" HeaderText="From"></asp:BoundField> 
