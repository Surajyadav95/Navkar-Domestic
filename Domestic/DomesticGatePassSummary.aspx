<%@ Page Title="Domestic |Domestic Gate Pass Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="DomesticGatePassSummary.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Domestic |Domestic Gate Pass Summary</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Domestic Gate Pass Summary
            </h3>
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group text-label">
                                    ...
                                    <asp:DropDownList ID="ddlCategory" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" class="form-control text-label">
                                        ...
                                        <asp:ListItem Value="1">Container No</asp:ListItem>
                                        <asp:ListItem Value="2">IGM-Item No</asp:ListItem>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                         <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Domestic/DomesticGatePassPrint.aspx?GPNo=" & (DataBinder.Eval(Container.DataItem, "GP No")).ToString()%>'target="_blank" 
