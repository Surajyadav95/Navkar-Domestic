<%@ Page Title="Domestic | Gate Out by Train" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="GateOutByTrain.aspx.vb" Inherits="Summary_BCYMovement" %>
...
<i class="glyphicon glyphicon-transfer"></i> Gate Out by Train (Loaded/Empty)
</h3>
...
<div class="form-group text-label" style="text-decoration-color:black">
<b >Out Date & Time</b>
<asp:TextBox ID="txtOutDate" Style="text-transform: uppercase" TextMode="DateTimeLocal" class="form-control text-label form-cascade-control"
runat="server"></asp:TextBox>     
</div>
</div>
...
function ValidationSave() {
    ...
    var txtOutDate = document.getElementById('<%= txtOutDate.ClientID%>').value;

var blResult = Boolean;
blResult = true;
      
if (txtOutDate == "") {
    document.getElementById('<%= txtOutDate.ClientID%>').style.borderColor = "red";
