<%@ Page Title="Domestic | Modify Container De-Stuff Date" Language="VB" EnableEventValidation="false" MasterPageFile="~/Domestic/PopUp.master" AutoEventWireup="false" CodeFile="ModifyStuffingDate.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Modify Container De-Stuff Date<small class="pull-left" style="margin-right:20px"></small></h1>
...
<div class="form-group text-label">
<b  >Stuffed  Pkgs</b>
<asp:TextBox ID="txtStuffedPkgs" Style="text-transform:uppercase" class="form-control text-label"  placeholder="Stuffed Pkgs"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b  >Stuffed  Weight</b>
<asp:TextBox ID="txtStuffedWeight" Style="text-transform:uppercase" class="form-control text-label"  placeholder="Stuffed Weight"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b  >DCA/Jo No</b>
<asp:TextBox ID="txtDCANo" Style="text-transform:uppercase" class="form-control text-label"  placeholder="DCA/Jo No"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group" style="padding-top:18px">                          
<a href="ModifyStuffingDate.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
Clear
</a>                               
</div>                                                                               
</div>
...
<a href="ModifyStuffingDate.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="ModifyStuffingDate.aspx" class="btn btn-danger ">No</a>
</div>
</div>
