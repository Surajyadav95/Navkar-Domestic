...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " USP_COIL_IN_SUMMARY '" & Convert.ToDateTime(txtfromDate.Text).ToString("yyyy-MM-dd 00:00:00 ") & "','" & Convert.ToDateTime(txttoDate.Text).ToString("yyyy-MM-dd 23:59:00 ") & "','" & Val(ddlCommodity.SelectedValue & "") & "'"
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Coil In Summary")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(11, 1).Value = "Coil In Summary"
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=CoilInSummary.xlsx")
