<%@ Page Title="Domestic |Domestic Cargo Inventory" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="DomesticCargoInventory.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Domestic |Domestic Cargo Inventory</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Domestic Cargo Inventory 
</h3>
       ...
       <div class="col-md-2 col-xs-12">
                                <div class="form-group text-label">
                                    ...
                                    <asp:DropDownList ID="ddlCategory"   runat="server"  OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"  AutoPostBack="true" class="form-control text-label">
                                        ...
                                        <asp:ListItem Value="2">Line Name</asp:ListItem>
...
<ItemStyle HorizontalAlign="Left" Width="50px" />
    ...
    <div class="row">
    <div class="col-md-8 col-xs-12"  style="margin-left:24px">
