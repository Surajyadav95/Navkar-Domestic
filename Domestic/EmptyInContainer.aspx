<%@ Page Title="Domestic |Empty In Container" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="EmptyInContainer.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Domestic |Empty In Container</title>
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Empty In Container
</h3>           
</div>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Gross Weight" >
                             <ItemTemplate>
                                 <asp:Label id="lblGrsWeight" runat="server" Text='<%# Eval("GrossWeight")%>'></asp:Label>
                             </ItemTemplate>
                        </asp:TemplateField>
    <asp:TemplateField HeaderText="Tare Weight" >
     ...
     <asp:TemplateField HeaderText="Shipping" >
                             <ItemTemplate>
                                 <asp:Label id="lblShipping" runat="server" Text='<%# Eval("Line")%>'></asp:Label>
                                 <asp:Label id="lblShippingID" Visible="false" runat="server" Text='<%# Eval("LineID")%>'></asp:Label>
                             </ItemTemplate>
...
<asp:Button ID="btnSave" class="btn btn-primary btn-sm outline " runat="server" OnClick="btnSave_Click1" 
...
<a href="EmptyInContainer.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
Clear
</a> 
...
<a href="EmptyInContainer.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
    ...
    <script type="text/javascript">
        ...
        function OpenSlipPrint() {
            ...
            var url = "../Report_Domestic/DomesticEmptyInPrint.aspx?SlipNo=" + txtSlipNoPrint
