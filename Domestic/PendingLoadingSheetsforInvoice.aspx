<%@ Page Title="Domestic | Pending Loading Sheets for Invoice" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="PendingLoadingSheetsforInvoice.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Domestic | Pending Loading Sheets for Invoice</title>
</head>
    
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Pending Loading Sheets for Invoice
</h3>
...
<asp:TextBox ID="txtfromDate" runat="server" TextMode="DateTimeLocal" Class="form-control text-label"></asp:TextBox>
...
<asp:ListItem Value="3">BOE No</asp:ListItem>                                                                     
<asp:ListItem Value="4">BL No / Ref JO No</asp:ListItem>                                                                     
...
<asp:DropDownList ID="ddlCustomer"   Style="text-transform: uppercase;"  runat="server" class="form-control text-label">
    ...
    <div class="col-md-4 col-xs-12" style="display: none;" id="divSearchText" runat="server" >
            <div class="form-group text-label">
...
<div class="row">
<div class="col-lg-12 col-xs-12 text-label "  style="padding-right:40px;">
<div class="table-responsive scrolling-table-container" style="margin-left:10px;margin-right:0px;">
<asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
AutoGenerateColumns="true" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true" OnPageIndexChanging="grdcontainer_PageIndexChanging"  AllowPaging="true" PageSize="10" >
