...
CodeFile="DomesticJobOrder.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<asp:TemplateField HeaderText="Total20's" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>

<asp:Label ID="lblTotal20s" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Total20s")%>'></asp:Label>
...
<asp:TemplateField HeaderText="20's Type" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>
    <asp:Label ID="lblType20" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Type20")%>'></asp:Label>
<asp:Label ID="lblTypeID20s" Visible="false" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TypeID20s")%>'></asp:Label>

</ItemTemplate>
<ItemStyle HorizontalAlign="center" />

</asp:TemplateField>
    <asp:TemplateField HeaderText="Total40's" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>
<asp:Label ID="lblTotal40s" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Total40s")%>'></asp:Label>
...
<ItemStyle HorizontalAlign="center" />
    ...
    <asp:TemplateField HeaderText="40's Type" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>

    <asp:Label ID="lblType40" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Type40")%>'></asp:Label>
<asp:Label ID="lblTypeID40s" AutoPostBack="true" Visibl="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TypeID40s")%>'></asp:Label>

</ItemTemplate>
<ItemStyle HorizontalAlign="center" />

</asp:TemplateField>
    <asp:TemplateField HeaderText="Total 45" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>

<asp:Label ID="Total45s" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Total45s")%>'></asp:Label>
...
<ItemStyle HorizontalAlign="center" />
     ...
     <asp:TemplateField HeaderText="45's Type" Visible="true"   HeaderStyle-CssClass="center1"   >
<ItemTemplate>

    <asp:Label ID="lblType45" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Type45")%>'></asp:Label>
<asp:Label ID="lblTypeID45s" AutoPostBack="true" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TypeID45s")%>'></asp:Label>
...
return blResult;
    ...
    <script>
        ...
        function btnAddClick() {
            var txttotal20 = document.getElementById('<%= txttotal20.ClientID%>').value;
            //var ddlCargoType = document.getElementById('<%= ddlCargoType.ClientID%>').value;
            var ddl20stype = document.getElementById('<%= ddl20stype.ClientID%>').value;
            var ddlTo = document.getElementById('<%= ddlTo.ClientID%>').value;
           ...
           <%-- if (txttotal20 == "") {
                document.getElementById('<%= txttotal20.ClientID%>').style.borderColor = "red";
                blResult = blResult && false;
            }
            if (ddl20stype == 0) {
                document.getElementById('<%= ddl20stype.ClientID%>').style.borderColor = "red";
                blResult = blResult && false;
            }--%>
          <%--  if (ddlFrom == 0) {
