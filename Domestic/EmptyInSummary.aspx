<%@ Page Title="Domestic |Empty In Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="EmptyInSummary.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Domestic |Empty In Summary</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Empty In Summary 
            </h3>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                         <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Domestic/DomesticEmptyInPrint.aspx?SlipNo=" & (DataBinder.Eval(Container.DataItem, "Entry ID")).ToString()%>'target="_blank" 
...
>Print</a>
    <asp:LinkButton ID="lnkCancel" ControlStyle-CssClass="btn btn-danger btn-xs outline"  Text="Cancel" OnClick="lnkCancel_Click" Visible="true"
                                                            ...
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Entry ID")%>' runat="server"
                                                            ></asp:LinkButton>
    </ItemTemplate>
