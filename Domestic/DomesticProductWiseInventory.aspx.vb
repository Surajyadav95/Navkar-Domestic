...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += " USP_DOMESTIC_PRODUCT_WISE_INVENTORY '" & Convert.ToDateTime(txtdate.Text).ToString("yyyy-MM-dd HH:mm") & "','" & Val(ddlCommodity.SelectedValue & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            grdcontainer.DataSource = dt
            grdcontainer.DataBind()
            For Each row As GridViewRow In grdcontainer.Rows
                If (row.RowIndex = dt.Rows.Count - 1) Then
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Product Wise Inventory")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Row(6).Height = 20
                        .Row(6).Height = 20
                        .Cell(6, 1).Value = "As On: " + Convert.ToDateTime(txtdate.Text).ToString("dd MMM yyyy HH:mm")
                        .Cell(6, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                        .Cell(7, 1).Value = "Product Wise Inventory"
                        ...
                        For i = 1 To dt.Columns.Count
                            .Cell(dt.Rows.Count + 8, i).Style.Fill.BackgroundColor = XLColor.Yellow
                        Next
                    End With
                    Response.Clear()
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=ProductWiseInventory.xlsx")
