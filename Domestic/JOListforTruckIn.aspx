<%@ Page Title="Bond" Language="VB" EnableEventValidation="false" MasterPageFile="~/Domestic/PopUp.master" AutoEventWireup="false" CodeFile="JOListforTruckIn.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>JO List<small class="pull-right" style="margin-right: 20px"></small></h1>
...
<b >Search</b>
<asp:TextBox ID="txtsearch" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search by JO No,Customer and BOE No"
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "JONo")%>' runat="server" OnClick="lnkselect_Click"
><i class="fa fa-check"></i></asp:LinkButton>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" Width="40px" />
</asp:TemplateField>
<asp:BoundField DataField="JONo" HeaderText="JO No" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
<asp:BoundField DataField="JODATE" HeaderText="JO Date"></asp:BoundField>
<asp:BoundField DataField="BENO" HeaderText="BE No"></asp:BoundField>
